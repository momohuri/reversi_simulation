...
namespace ConsoleApplication
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            for (int i = 0; i < 10; i++)
            {
                Console.WriteLine("nombre au premier thread :");
                int nombreDePremierThread = int.Parse(Console.ReadLine());

                Console.WriteLine("nombre au second thread :");
                int nombreDeSecondThread = int.Parse(Console.ReadLine());

                Console.WriteLine("nombre d'execution othello :");
                int nombreExecutionOthello = int.Parse(Console.ReadLine());

                Console.WriteLine("nombre de fois : ");
                int nombresdefois = int.Parse(Console.ReadLine());

                for (int nb = 1; nb <= nombresdefois; nb++)
                {
                    calcul(nombreDePremierThread, nombreDeSecondThread, nombreExecutionOthello);
                }
        ...
        public static void calcul(int nombreDePremierThread, int nombreDeSecondThread, int nombreExecutionOthello)
        {
            Stopwatch watch = new Stopwatch();
            watch.Start();

            Parallel.For(0, nombreDePremierThread, t =>
            {
                for (int op = 0; op < nombreExecutionOthello; op++)
                {
                    ...
                    for (int i = 0; i < 60; i++)
                    {
                        NextPossibility(ref grille, startupSearchPosition, pariteJoueur);
            ...
            watch.Stop();
            AfficheGrille(grille);
            Console.WriteLine(string.Format("{0} : {1} : {2} pour {3} othellos", watch.Elapsed.Minutes, watch.Elapsed.Seconds, watch.Elapsed.Milliseconds,
                nombreDePremierThread * nombreDeSecondThread * nombreExecutionOthello));
        }
